...
Idea: If every input symbol s in the cypher is mapped to a fixed output symbol 
...
write a perl script, that counts the occurance of a symbol in a message, and 
...
Das Leerzeichen scheint am häufigsten vorzukommen. Meine Vermutung ist, dass es 
sich dabei, tatsächlich um das Leerzeichen " " handelt.

Als nächst häufigstes Zeichen kommt "a" - es könnte sich hierbei um den 
Buchstaben "e" handeln.

Step 3 - naives Ersetzen
------------------------
...
So i tried swapping N to H in my map.
